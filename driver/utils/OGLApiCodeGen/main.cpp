...
#define CHECK_FILE(dir, name) \
    ...
    filename = dirGLInterceptor; filename.append("\\GLWrapper.cpp"); checkFile.open(filename); filename.clear();
    filename = dirGLInterceptor; filename.append("\\GLWrapper.h"  ); checkFile.open(filename); filename.clear();
    filename = dirGLInterceptor; filename.append("\\opengl3d.deff"); checkFile.open(filename); filename.clear();

    filename = dirGLInstrument; filename.append("\\GLIEntryPoints.cpp"); checkFile.open(filename); filename.clear();
    filename = dirGLInstrument; filename.append("\\GLIEntryPoints.h"); checkFile.open(filename); filename.clear();

    filename = dirTraceReader; filename.append("\\StubApiCalls.cpp"); checkFile.open(filename); filename.clear();
    filename = dirTraceReader; filename.append("\\StubApiCalls.h"); checkFile.open(filename); filename.clear();

    filename = dirGen; filename.append("\\GenAPICall.gen"); checkFile.open(filename); filename.clear();
    filename = dirGen; filename.append("\\GenGLConstantNames.gen"); checkFile.open(filename); filename.clear();
    filename = dirGen; filename.append("\\GenGLFunctionNames.gen"); checkFile.open(filename); filename.clear();
    filename = dirGen; filename.append("\\GenGLJumpTableFields.gen"); checkFile.open(filename); filename.clear();
    filename = dirGen; filename.append("\\GenGLJumpTableSL.gen"); checkFile.open(filename); filename.clear();
    filename = dirGen; filename.append("\\GenJumpTableWrapper.gen"); checkFile.open(filename); filename.clear();
    filename = dirGen; filename.append("\\GenPlayableCalls.gen"); checkFile.open(filename); filename.clear();
    filename = dirGen; filename.append("\\GenSwitchBranches.gen"); checkFile.open(filename); filename.clear();
...
//    }
    ...
    // extractor for GL functions supported by CG1GPU OGL library 
    ...
    cout << "Functions from CG1GPU OGL implementation: " << nLibFuncs << endl;
