...
#ifndef GALx_GENERICINSTRUCTION_H
    #define GALx_GENERICINSTRUCTION_H
...
public:
    ...
    GALxGenericInstruction(unsigned int line, 
...
#endif // GALx_GENERICINSTRUCTION_H
