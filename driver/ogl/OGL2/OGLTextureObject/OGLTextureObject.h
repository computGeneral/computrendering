...
#ifndef OGL_TEXTUREOBJECT
    #define OGL_TEXTUREOBJECT
...
public:
    ...
    void attachDevice(libGAL::GALDevice* device, GLuint target);
    libGAL::GALTexture* getTexture (); 
    ...
    GLenum getGLTextureFormat(libGAL::GAL_FORMAT format);
...
private:
    ...
    libGAL::GALTexture2D* _texture2D;
    libGAL::GALTexture3D* _texture3D;
    libGAL::GALTexture2D* _textureRECT;
    libGAL::GALTextureCubeMap* _textureCM;
