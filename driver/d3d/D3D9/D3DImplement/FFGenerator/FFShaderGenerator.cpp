...
DWORD FFShaderGenerator::genSourceTokenForTextureStageArg(U32 arg, D3DCOLORVALUE texStageConstantColor, D3DRegisterId current,
                                                          ...
                                                          bool diffuseDefined, bool specularDefined)
{
    ...
    switch(arg)
    {
        ...
        default:
            CG_ASSERT("Undefined operation argument.");
            break;
    }
...
DWORD FFShaderGenerator::genDestTokenForTextureStage(U32 stage, D3DRegisterId current, D3DRegisterId tempReg,
                                                     BYTE maskX, BYTE maskY, BYTE maskZ, BYTE maskW)
{
    ...
    switch(ff_state.textureStage[stage].resultArg)
    {
        ...
        default:
            CG_ASSERT("Undefined operation result argument.");
            break;
    }
...
void FFShaderGenerator::genCodeForTextureStageOp(D3DTEXTUREOP op, U32 arg1, U32 arg2, U32 arg3,
                                                 ...
                                                 D3DRegisterId defaultColor)
{
    ...
    {
        case D3DTOP_DISABLE:
            CG_ASSERT("Disable is not a correct operation.");
            break;
        ...
        case D3DTOP_LERP:
            CG_ASSERT("Unimplemented operation");
            break;

        default:
            CG_ASSERT("Undefined texture operation");
            break;
    }
...
bool FFShaderGenerator::checkUsageInVertexDeclaration(D3DUsageId usage)
{
    ...
    for(U32 u = 0; !found && (u < ff_state.vertexDeclaration.size()); u++)
