...
{
  // Cal llan�ar un event per avisar que volem canviar les dimensions de la
  // pantalla. Tamb� hem de llan�ar un event quan vulguem passar a FullScreen
  // perque la tra�a es va guardar originalment en aquest format. Ser� el player
  // qui pregunti a l'usuari que vol fer i nosaltres actuarem en conseq��ncia.
}
...
bool DXPainter::SaveDXTextureToStream(DXTexturePtr textura, IStream** rile)
{
  *rile = NULL;
