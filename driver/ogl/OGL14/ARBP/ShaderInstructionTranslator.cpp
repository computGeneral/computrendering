...
ShaderInstructionTranslator::ShaderInstructionTranslator(RBank<F32>& parametersBank,
...
list<cgoShaderInstr*> ShaderInstructionTranslator::preloadOperands(int line,
...
list<cgoShaderInstr*> ShaderInstructionTranslator::translateInstruction(GenericInstruction::Opcode opcode, int line, int num_operands,
                                                                           ShaderInstrOperand shop1,
                                                                           ShaderInstrOperand shop2,
                                                                           ShaderInstrOperand shop3,
...
/*    switch(opcode)
    {
        ...
        case GenericInstruction::G_MAD_SAT:
                code.push_back(new cgoShaderInstr(MAD,
                                            ...
                                            lastInstruction)); break;
        case GenericInstruction::G_MAX:
                code.push_back(new cgoShaderInstr(MAX,
                                            shop1.idBank, shop1.idReg,
                                            shop1.negateFlag, shop1.absoluteFlag,
                                            shop1.swizzleMode,
                                            shop2.idBank, shop2.idReg,
        ...
        case GenericInstruction::G_MIN_SAT:
                code.push_back(new cgoShaderInstr(MIN,
                                            ...
                                            lastInstruction)); break;
        case GenericInstruction::G_MOV:
                code.push_back(new cgoShaderInstr(MOV,
                                            shop1.idBank, shop1.idReg,
                                            shop1.negateFlag, shop1.absoluteFlag,
                                            shop1.swizzleMode,
                                            shop2.idBank, shop2.idReg,
...
list<cgoShaderInstr*> ShaderInstructionTranslator::generateEquivalentInstructionList(
...
U32 ShaderInstructionTranslator::getMaxAliveTemps()
{
    if ( maxLiveTempsComputed )
        return maxLiveTemps;
    CG_ASSERT("ApplyOptimizations must be called before this method");
    return 0;
}
...
void ShaderInstructionTranslator::returnASMCode(U08 *ptr, U32& size)
{
    char instr[128];
    *ptr = 0;
    list<cgoShaderInstr*>::iterator it = shaderCode.begin();
...
void ShaderInstructionTranslator::applyOptimizations(bool reorderCode)
{
    ...
    list<cgoShaderInstr*> optimized = schd.optimizeCode(shaderCode, HAL::getHAL()->getFetchRate(), 16, HAL::getHAL()->getMaxVertexAttribs(), driver->getMaxAddrRegisters(), reorderCode);
    if ( !optimized.empty() ) {
        clean();
