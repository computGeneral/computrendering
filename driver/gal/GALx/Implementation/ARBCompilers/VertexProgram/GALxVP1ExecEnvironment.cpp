...
{    
    YY_BUFFER_STATE parseBufferHandler = galxvp1_scan_bytes((const char*)code,size);
    ...
    galxvp1_delete_buffer(parseBufferHandler);
    ...
    */
    ...
    if (semtrav->foundErrors())
    {
        ...
        CG_ASSERT("Semantic error in Vertex Program");
    }
