...
int fps = 60;
char ProfilingFileName[256] = "tracefile.txt";
                   ...
                   LPSTR lpCmdLine, int iCmdShow)
{
    ...
    int error = gle.init(ProfilingFileName, bufferDescriptorsFileName, memRegFileName, true);        
    ...
    logfile().write(includelog::Init, "GLTracePlayer finished");
    logfile().popInfo();
        ...
        if ( *value == '=' )
        {
            *value = '\0';
            ...
            if ( EQ(option, "forward") )
                ...
                strcpy(ProfilingFileName, value);
