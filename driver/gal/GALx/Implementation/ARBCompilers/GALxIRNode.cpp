...
GALxIRNode::GALxIRNode()
: line(0)
{
}

GALxIRNode::GALxIRNode(unsigned int line)
: line(line)
{
}
...
: GALxIRNode(line), optionString(optionString)
{
}
...
void IRProgram::traverse(GALxIRTraverser* it)
{
    bool visit = true;
...
void VP1IROption::traverse(GALxIRTraverser* it)
{
    it->visitVP1Option(true,this,it);
}

void FP1IROption::traverse(GALxIRTraverser *it)
{
    it->visitFP1Option(true,this,it);
}

void IRInstruction::traverse(GALxIRTraverser *it)
{
    bool visit = true;
...
void IRSampleInstruction::traverse(GALxIRTraverser *it)
{
    bool visit = true;
...
void IRKillInstruction::traverse(GALxIRTraverser *it)
{
    bool visit = true;
...
void IRZExportInstruction::traverse(GALxIRTraverser *it)
{
    bool visit = true;
...
void IRCHSInstruction::traverse(GALxIRTraverser *it)
{
    bool visit = true;
...
void IRSwizzleComponents::traverse(GALxIRTraverser *it)
{
    it->visitSwizzleComponents(true,this,it);
}

void IRSwizzleInstruction::traverse(GALxIRTraverser *it)
{
    bool visit = true;
...
void IRDstOperand::traverse(GALxIRTraverser* it)
{
    it->visitDstOperand(true,this,it);
}

void IRArrayAddressing::traverse(GALxIRTraverser* it)
{
    it->visitArrayAddressing(true,this,it);
}

void IRSrcOperand::traverse(GALxIRTraverser* it)
{
    bool visit = true;
...
void IRALIASStatement::traverse(GALxIRTraverser* it)
{
    it->visitALIASStatement(true,this,it);
}

void IRTEMPStatement::traverse(GALxIRTraverser* it)
{
    it->visitTEMPStatement(true,this,it);
}

void IRADDRESSStatement::traverse(GALxIRTraverser* it)
{
    it->visitADDRESSStatement(true,this,it);
}

void VP1IRATTRIBStatement::traverse(GALxIRTraverser* it)
{
    it->visitVP1ATTRIBStatement(true,this,it);
}

void FP1IRATTRIBStatement::traverse(GALxIRTraverser* it)
{
    it->visitFP1ATTRIBStatement(true,this,it);
}

void VP1IROUTPUTStatement::traverse(GALxIRTraverser* it)
{
    it->visitVP1OUTPUTStatement(true,this,it);
}

void FP1IROUTPUTStatement::traverse(GALxIRTraverser* it)
{
    it->visitFP1OUTPUTStatement(true,this,it);
}

void IRPARAMStatement::traverse(GALxIRTraverser* it)
{
    bool visit = true;
...
void IRLocalEnvBinding::traverse(GALxIRTraverser* it)
{
    it->visitLocalEnvBinding(true,this,it);
}

void IRConstantBinding::traverse(GALxIRTraverser* it)
{
    it->visitConstantBinding(true,this,it);
}

void IRStateBinding::traverse(GALxIRTraverser* it)
{
