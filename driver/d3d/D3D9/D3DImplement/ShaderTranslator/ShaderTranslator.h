...
private:
    ShaderTranslator();
    ~ShaderTranslator();
    std::string printInstructionsDisassembled(std::vector<cg1gpu::cgoShaderInstr *> instr);
    std::string printInstructionsBinary(std::vector<cg1gpu::cgoShaderInstr *> instr);
