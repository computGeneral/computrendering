...
// Saves a screenshot in BMP format of client area of a window
...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR commandline, INT)
{
    ...
    hWnd = CreateWindow("D3DTracePlayer", "D3DTracePlayer",
    ...
    try
    {
        ...
        includelog::logfile().config("../../driver/d3d/trace/D3DTracePlayer/PIXLog.cfg");
        ...
        D3DTraceConfig &config = D3DTraceConfig::instance();
    ...
    UnregisterClass( "D3DTracePlayer", wc.hInstance );
