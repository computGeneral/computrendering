...
GLuint configureStream(GLContext* ctx, ::HAL* driver,
...
std::vector<GLuint> setVertexArraysBuffers(GLContext* ctx, ::HAL* driver,
                                                GLuint start, GLuint count,
 ...
 */
void drawElements(GLContext* ctx, ::HAL* driver, GLenum mode, GLsizei count, GLenum type, const GLvoid* indices);
...
U32 sendDB(DataBuffer<float>& db, ::HAL* drv);

/*
std::vector<unsigned int> setStreamBuffers(GLContext* ctx, ::HAL* driver, unsigned int start, unsigned int count);

// indexed version
std::vector<unsigned int> setStreamBuffers(GLContext* ctx, ::HAL* driver, std::set<GLuint>& iSet );

// VBO version + indexed
int setStreamBuffersVBO(GLContext* ctx, ::HAL* driver, BufferObject* bo);
*/

int sendIndices(::HAL* driver, const GLvoid* indices, GLenum indicesType, GLsizei count, GLint offset);

int sendIndices(::HAL* driver, const GLvoid* indices, GLenum indicesType, GLsizei count, const std::set<GLuint>& usedIndices);

int sendRawIndices(::HAL* driver, const GLvoid* indices, GLenum type, GLsizei count);

void setFragmentAttributes(::HAL* driver, GLContext* ctx);

/**
 * Sets all required state for this texture
 */
//void setupTexture(GLContext* ctx, ::HAL* driver, TextureObject& to);
void setupTexture(GLContext* ctx, ::HAL* driver, TextureObject& to, GLuint texUnit, GLenum kindOfAccess = 0);
 ...
 */
void synchronizeTextureImages(GLContext* ctx, ::HAL* driver, bool& disableColorMask);
 ...
 */
void setupShaders(GLContext* ctx, ::HAL* driver);
...
void setupHZTest(GLContext* ctx, ::HAL* driver);
...
//U32 writeTexture(GLContext* ctx, HAL* driver, TextureObject& to);
 ...
 *
 */
void performBlitOperation(GLint xoffset, GLint yoffset, GLsizei texWidth, GLint x, GLint y, GLsizei width, GLsizei height, U32 md, GLenum ifmt, GLsizei &size);
