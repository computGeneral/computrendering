 ...
 *
 * For example, the Polygon offset state in OpenGL Context state is implemented in OGL14 using 2 state variables 
 ...
 * @code
 *
 * HAL* driver = HAL::getHAL(); // Gets the 3D card driver
 *
...
private:
    ...
    HAL* driver;  ///< Pointer to access to the GPU Driver
