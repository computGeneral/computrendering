...

{
    ...
    //D3D9State::instance().addVertexBuffer(this, Length);

    // Create a new GAL Buffer
    galVertexBuffer = D3D9State::instance().createBuffer(Length);
...
HRESULT D3D_CALL AIVertexBufferImp9::Unlock() 
{
    ...
    //D3D9State::instance().updateVertexBuffer(this, OffsetToLock, actual_lock_size, lockedData);
    ...
    galVertexBuffer->updateData(OffsetToLock, actual_lock_size, (libGAL::gal_ubyte*) lData, D3D9State::instance().isPreloadCall());
...
libGAL::GALBuffer* AIVertexBufferImp9::getAcdVertexBuffer() 
{ 
    return galVertexBuffer;
}
