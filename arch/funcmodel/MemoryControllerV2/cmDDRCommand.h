...
public:
     ...
     */
    static const U32 AllBanks = 0xFFFFFFFF;
     ...
     */
    static DDRCommand* createActive(U32 bank, U32 row, ProtocolConstraint pc = PC_none);
     ...
     */
    static DDRCommand* createRead(U32 bank, U32 column, bool autoprecharge = false, ProtocolConstraint pc = PC_none);
     ...
     */
    static DDRCommand* createWrite(U32 bank, U32 column, DDRBurst* data, bool autoprecharge = false, ProtocolConstraint pc = PC_none);
     ...
     */
    static DDRCommand* createPrecharge(U32 bank, ProtocolConstraint pc = PC_none);
...
private:
    ...
    DDRCommand(DDRCmd cmd, U32 bank, U32 row, U32 column, bool autoprecharge, DDRBurst* data, ProtocolConstraint pc);
    ...
    U32 bank; ///< Bank selector
    U32 row; ///< Row selector
    U32 column; ///< Column selector
