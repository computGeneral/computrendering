...
//#endif //WIN32
    ...
    CG_ASSERT_COND((input != 0), "D3D9PixRunReader", "open", "Error opening PIX trace file.");
...
bool D3D9PixRunReader::readCID()
{
    ...
    // Type identifiers
    const U32 EVENT_CHUNK = 0x3EB;
    const U32 ASYNC_ATTRIBUTE_CHUNK = 0x3EC;
    const U32 D3DCALL_SYNC_EDID = 0x0B;
    const U32 PACKED_CALL_PACKAGE_ADID = 19;

    // For brevity
    const U32 sizeUL = sizeof(U32);
...
U32 D3D9PixRunReader::getFetchedEID() {
    return fetchedEID;
}
...
void D3D9PixRunReader::skip(U32 offset)
{
