...
private:
    U32 implicitFrontBufferAddr;     //<  Stores the memory descriptor (GPU memory) of the front color buffer created on device creation (default or implicit).
    U32 implicitBackBufferAddr;      //<  Stores the memory descriptor (GPU memory) of the back color buffer created on device creation (default or implicit).
    U32 implicitZStencilBufferAddr;  //<  Stores the memory descriptor (GPU memory) of the z and stencil buffer created on device creation (default or implicit).
    ...
    U32 colorBlockStateBufferMD;     //< Stores the memory descriptor (GPU memory) of the color block state buffer where block state data is saved.
    ...
    U32 stored_stream_address_0;
    U32 stored_stream_address_offset_0;
    ...
    U32 stored_vertex_program;
    U32 stored_vertex_program_offset;
    ...
    U32 stored_fragment_program;
    U32 stored_fragment_program_offset;
