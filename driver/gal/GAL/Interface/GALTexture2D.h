...
#ifndef GAL_TEXTURE2D
    #define GAL_TEXTURE2D
 ...
 * @date 28/03/2007
 */
class GALTexture2D : public GALTexture
{
public:
    ...
    virtual void copyData(gal_uint srcMipLevel, gal_uint dstMipLevel, GALTexture2D* destTexture) = 0;
    ...
    virtual void updateData( gal_uint mipLevel, const gal_ubyte* srcTexelData, gal_bool preloadData = false) = 0;
