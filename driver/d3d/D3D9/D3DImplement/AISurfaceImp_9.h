...
public:
    ...
    void setAsRenderTarget(libGAL::GALRenderTarget* rt);

    void setMipMapLevel(UINT m);
    void setFace(D3DCUBEMAP_FACES f);

    TextureType getD3D9Type();

    libGAL::GALTexture2D* getGALTexture2D();
    libGAL::GALRenderTarget* getGALRenderTarget();
...
private:
    ...
    libGAL::GALRenderTarget* renderTarget;
    UINT mipmap;
