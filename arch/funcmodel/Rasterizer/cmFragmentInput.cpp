...
U32 FragmentInput::getTriangleID() const
{
    return triangleID;
}

//  Gets the fragment setup triangle identifier.  
U32 FragmentInput::getSetupTriangle() const
{
    return setupTriangle;
}

//  Gets the fragment interpolated attributes.  
Vec4FP32 *FragmentInput::getAttributes() const
{
    return attributes;
}

//  Sets the fragment interpolated attributes array.  
void FragmentInput::setAttributes(Vec4FP32 *attrib)
{
    attributes = attrib;
}
...
void FragmentInput::setShaderUnit(U32 unit)
{
    shaderUnit = unit;
}

//  Gets the shader unit to which  the fragment was assigned.  
U32 FragmentInput::getShaderUnit() const
{
    return shaderUnit;
}
