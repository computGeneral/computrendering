...
private:
    ...
    public:
        ...
        void checkParamsIntegrity(const cgsArchConfig& arch);
     ...
     *
     *  @param arch Pointer to the Simulator Parameters structure where to
    ...
    bool parseSection(cgsArchConfig *arch);
     ...
     *  @param arch Pointer to the simulator parameters structure where
    ...
    bool parseSectionParameters(Section section, cgsArchConfig *arch);
    ...
    bool parseSimSectionParameter(cgsArchConfig *arch);
    ...
    /**
     *
     *  Parses a cmoStreamController section parameter.
     *
     *  @param strP Pointer to the cmoStreamController Parameters structure
     *  where to store the parsed parameter.
     *
     *  @return TRUE if the parameter was parsed correctly.
     *
    ...
    bool parseFShSectionParameter(cgsUnifiedShaderParam *fshP);
    ...
    /**
     *
     *  Parses a DisplayController section parameter.
     *
    ...
    bool parseDACSectionParameter(cgsDisplayCtrlParam *dacP);
    ...
    bool parseDecimalParameter(char *paramName, char *id, U32 &val);
    ...
    bool parseDecimalParameter(char *paramName, char *id, U64 &val);
    ...
    bool parseFloatParameter(char *paramName, char *id, F32 &val);
...
public:
    ...
    void getParameters(cgsArchConfig *simParam);
