...
//void initLibOGL14(HAL* driver, bool triangleSetupOnShader);
...
public:
    ...
    void save(const std::vector<U32>&  newClientDescriptors);
    void release();
...
public:
    ...
    void clear();
    void add(U32 vboName);
    bool used(U32 vboName);

private:

    std::vector<U32> vboNames;
};
...
extern std::vector<U32> prevDescriptors;
