...
TOKEN const perl_syntax_base::s_rgreg[ UCHAR_MAX + 1 ] =
{
...
TOKEN const perl_syntax_base::s_rgescape[ UCHAR_MAX + 1 ] =
{
/*  */   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/*  */   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/* 1*/   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/* 2*/   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/* 3*/   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/* 4*/   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/* 4*/   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/* 5*/   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/* 6*/   NO_TOKEN,   ESC_BEGIN_STRING, ESC_NOT_WORD_BOUNDARY,       NO_TOKEN,
       ESC_NOT_DIGIT, ESC_QUOTE_META_OFF,              NO_TOKEN,       NO_TOKEN,
/* 7*/   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/* 8*/   NO_TOKEN,  ESC_QUOTE_META_ON,              NO_TOKEN,  ESC_NOT_SPACE,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,   ESC_NOT_WORD,
/* 8*/   NO_TOKEN,           NO_TOKEN,        ESC_END_STRING,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/* 9*/   NO_TOKEN,           NO_TOKEN,     ESC_WORD_BOUNDARY,       NO_TOKEN,
           ESC_DIGIT,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/*10*/   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN,
/*11*/   NO_TOKEN,           NO_TOKEN,              NO_TOKEN,      ESC_SPACE,
            NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       ESC_WORD,
/*12*/   NO_TOKEN,           NO_TOKEN,      ESC_END_STRING_z,       NO_TOKEN,
           NO_TOKEN,           NO_TOKEN,              NO_TOKEN,       NO_TOKEN
// and the rest are 0...
};
