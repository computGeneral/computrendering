...
void D3DXmlGenerator::setClasses(vector<ClassDescription> &c) {
    classes = c;
}

void D3DXmlGenerator::setStructs(vector<StructDescription> &s) {
    structs = s;
}

void D3DXmlGenerator::setEnums(vector<EnumDescription> &e) {
    enums = e;
}

void D3DXmlGenerator::GenerateCode() {
...
void D3DXmlGenerator::generateMethod(ostream *o, Items::MethodDescription &m) {
...
void D3DXmlGenerator::generateClass(ostream *o, Items::ClassDescription &c) {
...
void D3DXmlGenerator::generateEnum(ostream *o, Items::EnumDescription &e) {
...
void D3DXmlGenerator::generateStruct(ostream *o, Items::StructDescription &s) {
...
void D3DXmlGenerator::generateFunctions(ostream *o) {
