...
struct CacheRequest
{
    U32 inAddress;   //  Address of the first byte of the line requested into the cache.  
    U32 outAddress;  //  Address of the first byte of the line requested out of the cache.  
...
class FetchCache : private bmoCacheTemplate<U32>
{
...
public:
    ...
    FetchCache(U32 numWays, U32 numLines, U32 lineBytes, U32 reqQueueSize,
        char *name = NULL);
    ...
    bool fetch(U32 address, U32 &way, U32 &line, bool &miss, DynamicObject *source = NULL, U32 reserves = 1);
    ...
    bool readLine(U32 way, U32 line, U08 *linePtr);
    ...
    bool writeLine(U32 way, U32 line, U08 *linePtr);
    ...
    bool write(U32 address, U32 way, U32 line, U32 size,
        U08 *data, bool *mask);
    ...
    CacheRequest *getRequest(U32 &requestID);
