...
#ifndef GALx_IRNODE_H
    #define GALx_IRNODE_H
#include <list>
#include <string>
...
public:
    GALxIRNode();
    GALxIRNode(unsigned int Line);

    void setLine(unsigned int Line) { this->line = Line; }
    
    unsigned int getLine() const { return line; }

    virtual void traverse(GALxIRTraverser*) = 0;
    virtual ~GALxIRNode();
};
...
class IRProgram: public GALxIRNode
{
private:
...
public:
    ...
    virtual void traverse(GALxIRTraverser*);
    virtual ~IRProgram();
};
...
class IROption: public GALxIRNode
{
private:
...
class IRStatement: public GALxIRNode
{
public:
...
class IRSwizzleComponents: public GALxIRNode
{
public:
...
class IRDstOperand: public GALxIRNode
{
private:
...
class IRArrayAddressing: public GALxIRNode
{
private:
...
class IRSrcOperand: public GALxIRNode
{
private:
...
class IRParamBinding: public GALxIRNode
{
private:
