...
FetchCache::FetchCache(U32 ways, U32 lines, U32 lineBytes, U32 reqQSize,
    char *fetchCacheName) :

    requestQueueSize(reqQSize), debugMode(false),
    bmoCacheTemplate<U32>(ways, lines, lineBytes, CACHE_NONE)
{
    U32 i;
    U32 j;
    ...
    else
    {
        ...
        //  Create statistics.  
        fetchMisses = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissesFetch_FC", U32(0), "FetchCache", name);
        fetchHits = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("HitsFetch_FC", U32(0), "FetchCache", name);
        fetchMissOK = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissOKFetch_FC", U32(0), "FetchCache", name);
        fetchMissFail = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissFailFetch_FC", U32(0), "FetchCache", name);
        fetchMissFailReqQ = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissFailReqQueueFetch_FC", U32(0), "FetchCache", name);
        fetchMissFailRes = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissFailReserveFetch_FC", U32(0), "FetchCache", name);
        fetchMissFailMiss = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissFailMissFetch_FC", U32(0), "FetchCache", name);
        allocMisses = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissesAlloc_FC", U32(0), "FetchCache", name);
        allocHits = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("HitsAlloc_FC", U32(0), "FetchCache", name);
        allocMissOK = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissOKAlloc_FC", U32(0), "FetchCache", name);
        allocMissFail = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissFailAlloc_FC", U32(0), "FetchCache", name);
        allocMissFailReqQ = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissFailReqQueueAlloc_FC", U32(0), "FetchCache", name);
        allocMissFailRes = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissFailReserveAlloc_FC", U32(0), "FetchCache", name);
        allocMissFailRes = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("MissFailMissAlloc_FC", U32(0), "FetchCache", name);
        readOK = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("ReadsOK_FC", U32(0), "FetchCache", name);
        readFail = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("ReadsFail_FC", U32(0), "FetchCache", name);
        writeOK = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("WritesOK_FC", U32(0), "FetchCache", name);
        writeFail = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("WritesFail_FC", U32(0), "FetchCache", name);
        readBytes = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("ReadBytes_FC", U32(0), "FetchCache", name);
        writeBytes = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("WriteBytes_FC", U32(0), "FetchCache", name);
        unreserves = &gpuStatistics::StatisticsManager::instance().getNumericStatistic("Unreserves_FC", U32(0), "FetchCache", name);
    }
...
bool FetchCache::fetch(U32 address, U32 &way, U32 &line, DynamicObject *source, U32 reserves)
{
    U32 freeRequest;
    U32 oldAddress;
    bool hit;
...
//printf("FetchCache (%s) => Reserving line at way = %d line = %d | inAddress = %x\n", name, way, line, line2address(way, line));
                ...
                //        CG_ASSERT("Spill and fill are for the same address!!");
                //)
...
//  Fetches a cache line.  
bool FetchCache::fetch(U32 address, U32 &way, U32 &line, bool &miss, DynamicObject *source, U32 reserves)
{
    U32 freeRequest;
    U32 oldAddress;
    bool hit;
...
//  Fetches a cache line.  
bool FetchCache::allocate(U32 address, U32 &way, U32 &line, DynamicObject *source, U32 reserves)
{
    U32 i;
    U32 freeRequest;
    U32 oldAddress;
...
bool FetchCache::read(U32 address, U32 way, U32 line, U32 size, U08 *data)
{
    U32 i;
    U32 off;
    ...
    CG_ASSERT_COND(!(((offset(address) & 0xfffffffc) + size) > lineSize), "Trying to read beyond the cache line.");
...
bool FetchCache::write(U32 address, U32 way, U32 line, U32 size,
    U08 *data)
{
    U32 i;
    U32 off;
    ...
    CG_ASSERT_COND(!(((offset(address) & 0xfffffffc) + size) > lineSize), "Trying to write beyond the cache line.");
    //  Check size is a multiple of 4 bytes.  
    ...
    U08 *data, bool *mask)
{
    ...
    GPU_ASSERT(
        if (tags[way][line] != tag(address))
        {
            ...
            CG_ASSERT("Trying to write an unfetched address.");
        }
    )
...
bool FetchCache::readLine(U32 way, U32 line, U08 *linedata)
{
    U32 i;
...
void FetchCache::readMask(U32 way, U32 line, U32 *mask)
{
    U32 i;
...
void FetchCache::resetMask(U32 way, U32 line)
{
...
bool FetchCache::writeLine(U32 way, U32 line, U08 *linedata)
{
    U32 i;
...
void FetchCache::unreserve(U32 way, U32 line)
{
    //  Liberate reserve.  
    if (reserve[way][line] > 0)
        reserve[way][line]--;
...
CacheRequest *FetchCache::getRequest(U32 &cacheRequest)
{
...
void FetchCache::freeRequest(U32 cacheRequest, bool freeSpill, bool freeFill)
{
    U32 way;
    U32 line;
    U32 i;
...
void FetchCache::access(U32 way, U32 line)
{
    S32 i;
    U32 aux;
    U32 aux2;
...
U32 FetchCache::nextVictim(U32 line)
{
    U32 i;
    U32 j;
