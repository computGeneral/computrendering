...
void TextureUnit::enableTarget(GLenum target)
{
    if ( target == GL_TEXTURE_1D )
        ...
        CG_ASSERT("Target not supported");
}
...
void TextureUnit::setParameter(GLenum target, GLenum pname, const GLfloat* param)
{
    if ( target == GL_TEXTURE_FILTER_CONTROL )
    {
        if ( pname != GL_TEXTURE_LOD_BIAS )
            CG_ASSERT("GL_TEXTURE_FILTER_CONTROL target with unexpected pname");
    ...
    if ( target != GL_TEXTURE_ENV )
        CG_ASSERT("Only target == GL_TEXTURE_ENV supported for now");
...
void TextureUnit::setParameter(GLenum target, GLenum pname, const GLint* param)
{
    ...
    if ( pname == GL_TEXTURE_ENV_MODE )
    {
        ...
        CG_ASSERT("Unknown texture function");
    }
...
//    }
    ...
    else if ( pname == GL_COMBINE_ALPHA )
    {
        ...
        CG_ASSERT("Unknown Alpha combine function");
    }
    else if ( pname == GL_RGB_SCALE )
    {
        if ( rgbScale != 1 && rgbScale != 2 && rgbScale != 4 )
            CG_ASSERT("GL_RGB_SCALE Must be 1, 2 or 4");
        rgbScale = param[0];
        return;
    }
    else if ( pname == GL_ALPHA_SCALE )
    {
        if ( alphaScale != 1 && alphaScale != 2 && alphaScale != 4 )
            CG_ASSERT("GL_ALPHA_SCALE Must be 1, 2 or 4");
        alphaScale = param[0];
        return;
    }
    else if ( pname == GL_SOURCE0_RGB )
    {
                                                                   ...
                                                                   "ATI_texture_env_combine3" extensions support */
        {
            ...
            CG_ASSERT("GL_SOURCE0_RGB unexpected value");
    }
    else if ( pname == GL_SOURCE1_RGB )
    {
                                                                   ...
                                                                   "ATI_texture_env_combine3" extensions support */
        {
            ...
            CG_ASSERT("GL_SOURCE1_RGB unexpected value");
    }
    else if ( pname == GL_SOURCE2_RGB )
    {
                                                                   ...
                                                                   "ATI_texture_env_combine3" extensions support */
        {
            ...
            CG_ASSERT("GL_SOURCE2_RGB unexpected value");
    }
    // For "NV_texture_env_combine4" extension support 
    else if ( pname == GL_SOURCE3_RGB_NV )
    {
             ...
             (param[0] == GL_ZERO))
        {
            ...
            CG_ASSERT("GL_SOURCE3_RBG_NV unexpected value");
    }
    ...
    else if ( pname == GL_SOURCE0_ALPHA )
    {
                                                                   ...
                                                                   "ATI_texture_env_combine3" extensions support */
        {
            ...
            CG_ASSERT("GL_SOURCE0_ALPHA unexpected value");
    }
    else if ( pname == GL_SOURCE1_ALPHA )
    {
                                                                   ...
                                                                   "ATI_texture_env_combine3" extensions support */
        {
            ...
            CG_ASSERT("GL_SOURCE1_ALPHA unexpected value");
    }
    else if ( pname == GL_SOURCE2_ALPHA )
    {
                                                                   ...
                                                                   "ATI_texture_env_combine3" extensions support */
        {
            ...
            CG_ASSERT("GL_SOURCE2_ALPHA unexpected value");
    }
    // For "NV_texture_env_combine4" extension support 
    else if ( pname == GL_SOURCE3_ALPHA_NV )
    {
             ...
             (param[0] == GL_ZERO))
        {
            ...
            CG_ASSERT("GL_SOURCE3_ALPHA_NV unexpected value");
    }
    ...
    else if ( pname == GL_OPERAND0_RGB )
    {
        ...
        CG_ASSERT("GL_OPERAND0_RGB unexpected value");
    }
    else if ( pname == GL_OPERAND1_RGB )
    {
        ...
        CG_ASSERT("GL_OPERAND1_RGB unexpected value");
    }
    else if ( pname == GL_OPERAND2_RGB )
    {
        ...
        CG_ASSERT("GL_OPERAND2_RGB unexpected value");
    }
    // For "NV_texture_env_combine4" extension support 
    else if ( pname == GL_OPERAND3_RGB_NV )
    {
        ...
        CG_ASSERT("GL_OPERAND3_RGB_NV unexpected value");
    }
    else if ( pname == GL_OPERAND0_ALPHA )
    {
        ...
        CG_ASSERT("GL_OPERAND0_ALPHA unexpected value");
    }
    else if ( pname == GL_OPERAND1_ALPHA )
    {
        ...
        CG_ASSERT("GL_OPERAND1_ALPHA unexpected value");
    }
    else if ( pname == GL_OPERAND2_ALPHA )
    {
        ...
        CG_ASSERT("GL_OPERAND2_ALPHA unexpected value");
    }
    // For "NV_texture_env_combine4" extension support 
    else if ( pname == GL_OPERAND3_ALPHA_NV )
    {
        ...
        CG_ASSERT("GL_OPERAND3_ALPHA_NV unexpected value");
    }
    CG_ASSERT("Unexpected Parameter");
...
{
    if ( n >= 4 )
        CG_ASSERT("only RGB sources from 0 to 3 are available");
    return srcRGB[n];
}
...
{
    if ( n >= 4 )
        CG_ASSERT("only alpha sources from 0 to 3 are available");
    return srcAlpha[n];
}
...
{
    if ( n >= 4 )
        CG_ASSERT("only RGB operands from 0 to 3 are available");
    return operandRGB[n];
}
...
{
    if ( n >= 4 )
        CG_ASSERT("only alpha operands from 0 to 3 are available");
