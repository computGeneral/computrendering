...
Pool(_Pool) 
{
    ...
    galIndexBuffer = D3D9State::instance().createBuffer(Length);
...
HRESULT D3D_CALL AIIndexBufferImp9::Unlock() 
{
    ...
    //D3D9State::instance().updateIndexBuffer(this, OffsetToLock, actual_lock_size, lockedData);
    ...
    galIndexBuffer->updateData(OffsetToLock, actual_lock_size, (libGAL::gal_ubyte*) lData, D3D9State::instance().isPreloadCall());
...
libGAL::GALBuffer* AIIndexBufferImp9::getAcdIndexBuffer() 
{
    return galIndexBuffer;
}
