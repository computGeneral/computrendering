...
//		 )
        ...
        if(flags & D3DCLEAR_ZBUFFER) {
            ...
            GPURegData gpu_z;
            gpu_z.uintVal = U32(d3d_z / 1.0f * 0x00FFFFFF);
...
void CRenderTargetZStencil9::setup_clear_shaders(DWORD color, float z) {
    ...
    U08 *memory = new U08[clear_vsh_size];
...
void CRenderTargetZStencil9::setup_clear_vertices() {
    ...
    gpu->writeMemory(clear_vb, (U08*)(vertices), sizeof(float) * 18);
