...
// {7C9DD65E-D3F7-4529-ACEE-785830GALE35} 
...
interface DECLSPEC_UUID("7C9DD65E-D3F7-4529-ACEE-785830GALE35") IDirect3DIndexBuffer9;
 ...
 */
#define _FGAL3D  0x876
#define MAKE_D3DHRESULT( code )  MAKE_HRESULT( 1, _FGAL3D, code )
#define MAKE_D3DSTATUS( code )  MAKE_HRESULT( 0, _FGAL3D, code )
