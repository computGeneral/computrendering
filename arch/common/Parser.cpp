...
Parser::Parser(char *string, U32 length)
{
    //  Set parse string.  
    str = string;
...
bool Parser::parseDecimal(S32 &val)
{
    U08 digit;
...
//  Parses a decimal integer.  
bool Parser::parseDecimal(S64 &val)
{
    U08 digit;
