...
public:
  ...
  void AbortLoading();
  bool LoadTraceStatistics(const std::string& ProfilingFilename);
  bool LoadTraceStatisticsOnTheFly(const std::string& ProfilingFilename, dxplugin::DXIntPluginManager& plugman);
