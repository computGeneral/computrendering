...
enum RastComm
{
    ...
    RSCOM_FRAME_CHANGE,             //  Fake swap sent to the DisplayController when the simulator is skipping draw calls.  
...
private:
    ...
    U32 subReg;          //  Rasterizer register subregister to write or read.  
...
public:
    ...
    RasterizerCommand(GPURegister reg, U32 subReg, GPURegData data);
