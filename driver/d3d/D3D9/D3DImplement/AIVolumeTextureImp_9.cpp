    ...
    
{
    ...
    //D3D9State::instance().addVolumeTexture(this);

    
    // Create a new GAL Volume Texture
    galVolumeTexture = D3D9State::instance().createVolumeTexture();

    D3D9State::instance().addTypeTexture((AIBaseTextureImp9*)this, D3D9_VOLUMETEXTURE);
    ...
    for (UINT i = 0; i < numLevels; i++)
    {
        ...
        //D3D9State::instance().addVolumeLevel(this, i_mipmap, i, mip_width, mip_height, mip_depth, Format);
    ...
    mipVolumesLevels[vol] = mipLevel;*/
        ...
        galVolumeTexture->setData(i, mip_width, mip_height, mip_depth, D3D9State::instance().getGALFormat(Format), 0, /*(libGAL::gal_ubyte*)data*/NULL, size);
...
libGAL::GALTexture3D* AIVolumeTextureImp9::getGALVolumeTexture() 
{
    return galVolumeTexture;
}
