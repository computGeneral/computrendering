...
U32 ColorCache::cacheCounter = 0;


//  Color cache constructor.  
ColorCache::ColorCache(U32 ways, U32 lines, U32 stampsLine,
        U32 bytesStamp, U32 readP, U32 writeP, U32 pWidth, U32 reqQSize, U32 inReqs,
        U32 outReqs, bool comprDisabled, U32 maxColorBlocks, U32 blocksPerCycle,
...
bool ColorCache::fetch(U32 address, U32 &way, U32 &line, DynamicObject *source)
{
...
bool ColorCache::allocate(U32 address, U32 &way, U32 &line, DynamicObject *source)
{
    U32 i;
    U32 e;
    U32 block;
...
bool ColorCache::read(U32 address, U32 way, U32 line, U08 *data)
{
    U32 i;
...
bool ColorCache::write(U32 address, U32 way, U32 line, U08 *data,
    bool *mask)
{
    U32 i;
...
void ColorCache::unreserve(U32 way, U32 line)
{
...
MemoryTransaction *ColorCache::update(U64 cycle, MemState memState)
{
...
bool ColorCache::clear(U32 color)
{
    //  Reset the cache.  
    if (clearMode)
    {
...
void ColorCache::swap(U32 bufferAddress)
{
...
void ColorCache::clock(U64 cycle)
{
    U32 i, e;
    U32 readEndReq;
    ...
    //U08 comprBuffer2[UNCOMPRESSED_BLOCK_SIZE];
            ...
            switch(blockState[readQueue[nextRead].block])
            {
                case COLOR_BLOCK_CLEAR:
                    ...
                    for(i = 0; i < lineSize; i += 4)
                        *((U32 *) &inputBuffer[nextRead][i]) = clearColor;
    ...
    if ((writeOutputs > 0) && (compressCycles == 0))
    {
        ...
        if ((!disableCompr) && (blockState[writeQueue[nextWrite].block] != COLOR_BLOCK_UNCOMPRESSED))
        {
            ...
            bmoFragmentOperator::blockMinMax((U32 *) comprBuffer, lineStamps * 4, min, max);
...
MemoryTransaction *ColorCache::requestBlock(U32 readReq)
{
    U32 size;
    U32 offset;
    MemoryTransaction *memTrans;
...
//  Requests a compressed block/line of data.  
MemoryTransaction *ColorCache::writeBlock(U32 writeReq)
{
    U32 size;
    U32 offset;
    MemoryTransaction *memTrans;
...
void ColorCache::copyBlockStateMemory(ColorBlockState *buffer, U32 blocks)
{
...
U32 ColorCache::address2block(U32 address)
{
    U32 block;
