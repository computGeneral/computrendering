...
public:
    ...
    virtual U32 getNumberOfInstructions() const = 0;
    virtual U32 getNumberOfParamRegs() const = 0;
    virtual U32 getNumberOfTempRegs() const = 0;
    virtual U32 getNumberOfAddrRegs() const = 0;
    virtual U32 getNumberOfAttribs() const = 0;
...
public:
     ...
     * Methods for retrieving results
     */
    virtual RBank<F32> getParametersBank() = 0;
    virtual void returnGPUCode(U08* bin, U32& size) = 0;
    virtual U32 getMaxAliveTemps() = 0;
...
protected:
     ...
     */     
    virtual void dependantCompilation(const U08* code, U32 codeSize, GenerationCode::SemanticTraverser*& ssc, ShaderCodeGeneration*& scg)=0;
...
{
    void dependantCompilation(const U08* code, U32 codeSize, GenerationCode::SemanticTraverser*& ssc, ShaderCodeGeneration*& scg);
};
