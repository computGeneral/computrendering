...
void IRDisassembler::visit(CommentIRNode *n)
{
    ...
    *out << buffer;
    ...
    for(U32 child = 0; child < commentData.size(); child++)
    {
        if (lineElements == 0)
        {
            *out << endl;
    ...
    if (lineElements > 0)
    {
        for(U32 e = 0; e < (16 - lineElements); e++)
        {
            strcpy(auxBuffer, buffer);
            sprintf(buffer, "%s   ", auxBuffer);
        }
...
{
    CG_ASSERT("Only supported in derived classes.");
}
...
void IRDisassembler::visit(SourceParameterIRNode *n)
{
    ...
    switch(n->getRegisterType())
    {
        ...
        case D3DSPR_RASTOUT:
        case D3DSPR_ATTROUT:
            CG_ASSERT("Output register used as source.");
            break;
        ...
        case D3DSPR_LABEL:
            ...
            break;
        default:
            CG_ASSERT("Unknown register type");
            break;
    }
        ...
        case D3DSPR_MISCTYPE:
            ...
            switch (n->getNRegister())
            {
                ...
                case D3DSMO_FACE:
                    ...
                    break;
                default:
                    CG_ASSERT("Undefined misc register.");
                    break;
            }
    ...
    switch(n->getModifier())
    {
        ...
        default:
            CG_ASSERT("Unknown source modifier.");
            break;
    }
        ...
        case D3DSPR_RASTOUT:
            ...
            switch(n->getNRegister())
            {
                ...
                case D3DSRO_POINT_SIZE:
                    ...
                    break;
                default:
                    CG_ASSERT("Undefined raster out register.");
                    break;
            }
        ...
        if (n->getRegisterType() == D3DSPR_ADDR)
        {
            ...
            switch(n->getComponentIndex())
            {
                ...
                case 3:
                    ...
                    break;
                default:
                    CG_ASSERT("Unknown component index.");
                    break;
            }
            strcpy(auxBuffer, buffer);
            sprintf(buffer, "%s]", auxBuffer);
