...
bool DXPlayerStatisticsData::LoadTraceStatistics(const string& ProfilingFilename)
{
  bool problems = false;
  ...
  if (!traceman.OpenRead(ProfilingFilename))
  {
    NotifyEnded();
    return false;
  }
...
bool DXPlayerStatisticsData::LoadTraceStatisticsOnTheFly(const std::string& ProfilingFilename, dxplugin::DXIntPluginManager& plugman)
{
  bool problems = false;
