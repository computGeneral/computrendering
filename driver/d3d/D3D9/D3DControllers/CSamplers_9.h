...
private:
    ...
    U32 get_assigned_texture_unit(UINT sampler);

    void reset_texture(U32 texture_unit);
    U32 default_texture;

    void update_texture(StateDataNode* s_texture, U32 texture_unit);
    void update_addressing(StateDataNode* s_sampler, U32 texture_unit);
    void update_filtering(StateDataNode* s_sampler, U32 texture_unit);
