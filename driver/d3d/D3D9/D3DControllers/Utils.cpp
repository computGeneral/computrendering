...
UINT getVolumeSize(UINT Width, UINT Height, UINT Depth, D3DFORMAT Format) {
    ...
    switch(Format)
    {
        ...
        case D3DFMT_ATI2:
            ...
            CG_ASSERT("Volumes with compressed formats not implemented.");
            break;
        default:
...
UINT getSurfacePitchGAL(UINT Width, D3DFORMAT Format)
{
    UINT pitch;
...
UINT get_index_size(D3DFORMAT IndexDataFormat)
{
    ...
    switch(IndexDataFormat) 
    {
        ...
        case D3DFMT_INDEX32:
            ...
            break;
        default:
            CG_ASSERT("Index format unknown");
            break;
    }
    return size;
}
...
void d3dcolor2quadfloat(D3DCOLOR in, Vec4FP32* out) {
