...
void WRITE( Signal& s, U32 cycle, char* data, U32 latency )
{
...
void WRITE( Signal& s, U32 cycle, char* data )
{
...
void READ( Signal& s, U32 cycle, char* data )
{
...
void executeOperation( Signal& s, char* buffer, U32 size )
{
	

	U32 latency, cycle, i, j, ini;
	char* data = 0;
