...
public:
    ...
    cg1gpu::ShaderInstruction *buildInstruction();
...
list<cg1gpu::ShaderInstruction*> generate_ending_nops();

//* generate a mov instruction, not surprisingly *
cg1gpu::ShaderInstruction* generate_mov(GPURegisterId dest, GPURegisterId src);
