...
GALxTLShader* GALxFPFactory::tlshader;
GALxFPState* GALxFPFactory::fps;
GALxCodeSnip GALxFPFactory::code;

// Assembles the program parts created by the different construction functions 
GALxTLShader* GALxFPFactory::constructFragmentProgram(GALxFPState& fps)
{
    GALxFPFactory::fps = &fps;
...
void GALxFPFactory::constructInitialization()
{
    ...
    if (fps->anyTextureUnitEnabled())
    {
        for (int i=0; i<fps->maxTextureUnits(); i++)
        {
            ...
            {
                GALxFPState::TextureUnit textureUnit = fps->getTextureUnit(i);
                stringstream ss;
                string t;
                ss << i;
                t = ss.str();
    ...
    if (fps->fogEnabled() ||
       (fps->alphaTestEnabled() && ((fps->alphaTestFunc() != GALxFPState::ALWAYS) && (fps->alphaTestFunc() != GALxFPState::NEVER))))
        text += "TEMP finalColor;\n";

    if (fps->alphaTestEnabled() && ((fps->alphaTestFunc() != GALxFPState::ALWAYS) && (fps->alphaTestFunc() != GALxFPState::NEVER)))
        text += "TEMP testReg;\n";
...
void GALxFPFactory::constructFragmentProcessing()
{
    if (fps->anyTextureUnitEnabled())
        constructTexturing();
...
void GALxFPFactory::constructPostProcessingTests()
{
    if (fps->alphaTestEnabled() && (fps->alphaTestFunc() != GALxFPState::ALWAYS))
        constructAlphaTest();
}

void GALxFPFactory::constructAlphaTest()
{
    string text = "# ------------ Alpha Test ----------------\n";

    
    std::vector<GALx_STORED_FP_ITEM_ID> vState;
    vState.push_back(GALx_ALPHA_TEST_REF_VALUE);
    ...
    {
        case GALxFPState::NEVER:
            text += "# Alpha Test Function: NEVER\n"
                    "KIL {-1,-1,-1,-1};\n";
            break;

        case GALxFPState::LESS:
...
void GALxFPFactory::computeTextureApplication(GALxFPState::TextureUnit textureUnit, string inputFragmentColorTemp, string outputFragmentColorTemp, string primaryColorRegister)
{
    string comments;
    ...
    {
        case GALxFPState::TextureUnit::TEXTURE_1D:  target = string("1D"); break;
        case GALxFPState::TextureUnit::TEXTURE_2D:  target = string("2D"); break;
        case GALxFPState::TextureUnit::TEXTURE_3D:  target = string("3D"); break;
        case GALxFPState::TextureUnit::CUBE_MAP:    target = string("CUBE"); break;
    }
    ...
    {
        case GALxFPState::TextureUnit::REPLACE:

            comments += "# -- Modulation texture function: REPLACE\n";

            switch(textureUnit.format)
            {
                case GALxFPState::TextureUnit::ALPHA:
                ...
                case GALxFPState::TextureUnit::LUMINANCE:
                ...
                case GALxFPState::TextureUnit::LUMINANCE_ALPHA:
                ...
                case GALxFPState::TextureUnit::DEPTH:

                    comments += "# -- Base Internal Format: DEPTH\n";

                    CG_ASSERT("Depth component Base Internal Format not supported yet");

                    break;

                case GALxFPState::TextureUnit::INTENSITY:
                ...
                case GALxFPState::TextureUnit::RGB:
                ...
                case GALxFPState::TextureUnit::RGBA:
        ...
        case GALxFPState::TextureUnit::MODULATE:
        ...
        case GALxFPState::TextureUnit::DECAL:
        ...
        case GALxFPState::TextureUnit::BLEND:
        ...
        case GALxFPState::TextureUnit::ADD:
        ...
        case GALxFPState::TextureUnit::COMBINE4_NV:
        
            isCombine4NV = true;
            // Fall into conventional COMBINE branch 
            
        case GALxFPState::TextureUnit::COMBINE:
        {
            ...
            {
                case GALxFPState::TextureUnit::CombineMode::REPLACE:
                ...
                case GALxFPState::TextureUnit::CombineMode::MODULATE:
                ...
                case GALxFPState::TextureUnit::CombineMode::ADD:
                ...
                case GALxFPState::TextureUnit::CombineMode::ADD_SIGNED:
                ...
                case GALxFPState::TextureUnit::CombineMode::INTERPOLATE:
                ...
                case GALxFPState::TextureUnit::CombineMode::SUBTRACT:
                ...
                case GALxFPState::TextureUnit::CombineMode::DOT3_RGB:
                ...
                case GALxFPState::TextureUnit::CombineMode::DOT3_RGBA:
                ...
                case GALxFPState::TextureUnit::CombineMode::MODULATE_ADD_ATI:
                ...
                case GALxFPState::TextureUnit::CombineMode::MODULATE_SIGNED_ADD_ATI:
                ...
                case GALxFPState::TextureUnit::CombineMode::MODULATE_SUBTRACT_ATI:
            ...
            for (i=0; i<combineRGBOperands; i++)
            {
                ...
                {
                    case GALxFPState::TextureUnit::CombineMode::TEXTURE:

                        comments += "# -- Combine RGB Source" + numOperand + " : TEXTURE\n";
                        RGBOperandRegister[i].name = TEXTURELOOKUPCOLOR(unit);
                        break;

                    case GALxFPState::TextureUnit::CombineMode::TEXTUREn:
                    {
                    ...
                    case GALxFPState::TextureUnit::CombineMode::ZERO:
                    ...
                    case GALxFPState::TextureUnit::CombineMode::ONE:
                ...
                {
                    case GALxFPState::TextureUnit::CombineMode::SRC_COLOR:

                        comments += "# -- Combine RGB Operand" + numOperand + " : SRC_COLOR\n";
                        RGBOperandRegister[i].swizzle = "rgba";
                        break;

                    case GALxFPState::TextureUnit::CombineMode::ONE_MINUS_SRC_COLOR:

                        /* Detect special cases as 1 - ZERO or 1 - 1
                         * that are equivalent to Source = ONE and Source = ZERO respectively 
                         */
                        if (textureUnit.combineMode.srcRGB[i] == GALxFPState::TextureUnit::CombineMode::ZERO)
                        {
                            RGBOperandRegister[i].name = ONE_CONSTANT;
                            RGBOperandRegister[i].swizzle = "rgba";
                        }
                        else if (textureUnit.combineMode.srcRGB[i] == GALxFPState::TextureUnit::CombineMode::ONE)
                        {
                            RGBOperandRegister[i].name = ZERO_CONSTANT;
                            RGBOperandRegister[i].swizzle = "rgba";
                        }
                    ...
                    case GALxFPState::TextureUnit::CombineMode::SRC_ALPHA:

                        comments += "# -- Combine RGB Operand" + numOperand + " : SRC_ALPHA\n";
                        RGBOperandRegister[i].swizzle = "aaaa";
                        break;

                    case GALxFPState::TextureUnit::CombineMode::ONE_MINUS_SRC_ALPHA:
            ...
            for (i=0; i<combineALPHAOperands; i++)
            {
                ...
                switch(textureUnit.combineMode.operandALPHA[i])
                {
                    ...
                    case GALxFPState::TextureUnit::CombineMode::ONE_MINUS_SRC_COLOR:
                         ...
                         * that are equivalent to Source = ONE and Source = ZERO respectively 
                         */
                        if (textureUnit.combineMode.srcALPHA[i] == GALxFPState::TextureUnit::CombineMode::ZERO)
                        {
                            ALPHAOperandRegister[i].name = ONE_CONSTANT;
                            ALPHAOperandRegister[i].swizzle = "rgba";
                        }
                        else if (textureUnit.combineMode.srcALPHA[i] == GALxFPState::TextureUnit::CombineMode::ONE)
                        {
                            ALPHAOperandRegister[i].name = ZERO_CONSTANT;
                            ALPHAOperandRegister[i].swizzle = "rgba";
                        }
        ...
        default:
            CG_ASSERT("Unexpected Texture Function");
...
void GALxFPFactory::computeTextureApplicationTemporaries()
{
    string text;
    ...
    for (i=0; i<fps->maxTextureUnits(); i++)
    {
        if ( fps->isTextureUnitEnabled(i) )
        {
            ...
            if (textureUnit.function == GALxFPState::TextureUnit::COMBINE || 
                textureUnit.function == GALxFPState::TextureUnit::COMBINE4_NV)
            {
                unsigned int combineRGBOperands, combineALPHAOperands;
                
                bool isCombine4NV = (textureUnit.function == GALxFPState::TextureUnit::COMBINE4_NV);
                
                switch(textureUnit.combineMode.combineRGBFunction)
                {
                    case GALxFPState::TextureUnit::CombineMode::REPLACE: combineRGBOperands = 1; break;
                    case GALxFPState::TextureUnit::CombineMode::MODULATE: combineRGBOperands = 2; break;
                    case GALxFPState::TextureUnit::CombineMode::ADD: if (!isCombine4NV)
                                                                    combineRGBOperands = 2;
                                                                 else // isCombine4NV
                                                                 {
                                                                    combineRGBOperands = 4;
                    ...
                    case GALxFPState::TextureUnit::CombineMode::ADD_SIGNED: if (!isCombine4NV)
                                                                        {
                                                                            combineRGBOperands = 2;
                    ...
                    case GALxFPState::TextureUnit::CombineMode::INTERPOLATE: combineRGBOperands = 3; break;
                    case GALxFPState::TextureUnit::CombineMode::SUBTRACT: combineRGBOperands = 2; break;
                    case GALxFPState::TextureUnit::CombineMode::DOT3_RGB: combineRGBOperands = 2; 
                                                                      temporaryForRGBOperand[0] = true;
                                                                      temporaryForRGBOperand[1] = true;
                                                                      break;
                    case GALxFPState::TextureUnit::CombineMode::DOT3_RGBA: combineRGBOperands = 2; 
                                                                       temporaryForRGBOperand[0] = true;
                                                                       temporaryForRGBOperand[1] = true;
                                                                       break;
                    
                    // For "ATI_texture_env_combine3" extension support 
                    case GALxFPState::TextureUnit::CombineMode::MODULATE_ADD_ATI:        combineRGBOperands = 3; break;
                    case GALxFPState::TextureUnit::CombineMode::MODULATE_SIGNED_ADD_ATI: combineRGBOperands = 3; break;
                    case GALxFPState::TextureUnit::CombineMode::MODULATE_SUBTRACT_ATI:   combineRGBOperands = 3; break;
                ...
                switch(textureUnit.combineMode.combineALPHAFunction)
                {
                    case GALxFPState::TextureUnit::CombineMode::REPLACE: combineALPHAOperands = 1; break;
                    case GALxFPState::TextureUnit::CombineMode::MODULATE: combineALPHAOperands = 2; break;
                    case GALxFPState::TextureUnit::CombineMode::ADD: if (!isCombine4NV)
                                                                    combineALPHAOperands = 2;
                                                                 else // isCombine4NV
                                                                 {
                    ...
                    case GALxFPState::TextureUnit::CombineMode::INTERPOLATE: combineALPHAOperands = 3; break;
                    case GALxFPState::TextureUnit::CombineMode::SUBTRACT: combineALPHAOperands = 2; break;

                       // For "ATI_texture_env_combine3" extension support 
                    case GALxFPState::TextureUnit::CombineMode::MODULATE_ADD_ATI:        combineALPHAOperands = 3; break;
                    case GALxFPState::TextureUnit::CombineMode::MODULATE_SIGNED_ADD_ATI: combineALPHAOperands = 3; break;
                    case GALxFPState::TextureUnit::CombineMode::MODULATE_SUBTRACT_ATI:   combineALPHAOperands = 3; break;
            ...
            else if (textureUnit.function == GALxFPState::TextureUnit::COMBINE4_NV)
            {
...
void GALxFPFactory::constructTexturing()
{
    string text;
    stringstream ss;
    string t;
...
void GALxFPFactory::computeColorSum()
{
    string text;
...
void GALxFPFactory::computeFogApplication()
{
...
void GALxFPFactory::computeDepthBypass()
{
    string text = "MOV result.depth.z, iPos.z;\n";
    code.append(text);
}

void GALxFPFactory::computeFogFactor()
{
    if (fps->fogMode() == GALxFPState::LINEAR)
    {
        std::vector<GALx_STORED_FP_ITEM_ID> vState;
        vState.push_back(GALx_FOG_LINEAR_START);
        vState.push_back(GALx_FOG_LINEAR_END);
    ...
    else if (fps->fogMode() == GALxFPState::EXP)
    {
        std::vector<GALx_STORED_FP_ITEM_ID> vState;
        vState.push_back(GALx_FOG_DENSITY);
    ...
    else if (fps->fogMode() == GALxFPState::EXP2)
    {
        std::vector<GALx_STORED_FP_ITEM_ID> vState;
        vState.push_back(GALx_FOG_DENSITY);
...
void GALxFPFactory::computeFogCombination()
{
    string writeRegister;
    string text;
...
GALxTLShader* GALxFPFactory::constructSeparatedAlphaTest(GALxFPState& fps)
{
    GALxFPFactory::fps = &fps;
