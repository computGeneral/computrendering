...
//printf("CP %lld => Change to stacked state (%d)\n", cycle, stateStack);
        ...
        case GPU_SWAP:
            ...
            //  Check if DisplayController.has finished dumping the framebuffer.  
...
//printf("CP %lld => Change to READY state.\n", cycle);
        ...
        case GPU_DUMPBUFFER:
            ...
            //  Check if DisplayController.has finished dumping the buffer.
            if (dacState == RAST_END)
            {
                //  Send END command to the DisplayController unit.
                rastComm = new RasterizerCommand(RSCOM_END);
        ...
        case GPU_BLITTING:
            ...
            //  Check if DisplayController.has finished performing bit blit operation.  
            if (dacState == RAST_END)
            {
                //  Send END command to the DisplayController unit.  
                rastComm = new RasterizerCommand(RSCOM_END);
